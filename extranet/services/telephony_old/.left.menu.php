...
if(CModule::IncludeModule('voximplant'))
{
	$aMenuLinks = Array(
		Array(
			...
			"/extranet/services/telephony/lines.php",
		...
		Array(
			...
			"/extranet/services/telephony/index.php",
		...
		Array(
			...
			"/extranet/services/telephony/users.php",
			Array(),
		...
		Array(
			...
			"/extranet/services/telephony/groups.php",
		...
		Array(
			...
			"/extranet/services/telephony/phones.php",
			Array(),
		...
		Array(
			...
			"/extranet/services/telephony/permissions.php",
		...
		Array(
			...
			"/extranet/services/telephony/ivr.php",
		...
		Array(
			...
			"/extranet/services/telephony/configs.php",
			Array(),
